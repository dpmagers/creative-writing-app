    ...
    return (
        ...
        <div>
            ...
            <div className="right-column">
                ...
                <Button variant="contained" color="secondary" onClick={handleNewWritingClick}>      New Writing Page
                </Button>
                <Typography variant="h5" gutterBottom>
                    Read creative writing by your classmates!                
                </Typography>
                <Button variant="contained" color="secondary" onClick={handleClassroomWritingClick}>Classroom Writing Page</Button>
